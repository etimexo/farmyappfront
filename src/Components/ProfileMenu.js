...
function ProfileMenu() {
  ...
  return (
    <div className="profilemenu">
      ...
      <img src={userInfo.avatar ? userInfo.avatar : profback} alt="profile background" className="profimg" />
      <div className="profName">
        {userInfo.farmName && <p className="profName">{userInfo.farmName}</p>}
        {userInfo.storeName && <p className="profName">{userInfo.storeName}</p>}
        {userInfo.logisticsCompanyName && <p className="profName">{userInfo.logisticsCompanyName}</p>}
        <p className="profName">@{userInfo.username}</p>
      </div>
      <div className="manuopt">
        <Link to="/editfarmproduct"> {/* Link to the farmer's page */}
          <p className="manuopt">My Market</p>
        </Link>
        <div className="subopt">
          <Link>
